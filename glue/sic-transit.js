...
*/
    performTransition(args){
     ...
     // Edit: Safari flicker issue seems to be resolved now. Switching to navigator.locks.request().
        ...
        */
       navigator.locks.request("animationLock", async (lock) => {
...
/* Lookup table for transition parameters. Shouldn't have to do anything with this unless you're defining a new transition or fixing a bug.  */
    dispatchTable =  {
        ...
        "crossDissolveIn": {
            ...
            firstanimation: [{ display:"grid", opacity: 0}, {display:"grid",opacity:1}],
            secondanimation: [{display:"grid", opacity:1}, {display:"grid", opacity:0}],
            boxShadow: "10px 10px 20px rgba(0,0,0,0.5)",
            easing: 'ease-in-out',
            duration:2000,
            callback:null,
        ...
        "crossDissolveOut": {
            ...
            firstanimation: [{ display:"grid", opacity:1}, {display:"grid",opacity:0}],
            secondanimation: [{display:"grid", opacity:0}, {display:"grid", opacity:1}],
            boxShadow: "10px 10px 20px rgba(0,0,0,0.5)",
            easing: 'ease-in-out', 
            duration:2000,
            callback:null
        ...
        "irisIn":{
            ...
            firstanimation: [{display:"grid", clipPath:"circle(0% at center"}, {display:"grid",  clipPath:"circle(100% at center)"}],
            easing:'ease-in-out',
            duration:1000,
            callback:null,
            prefersReducedMotion:"cutIn"
        ...
        "irisOut":{
            ...
            firstanimation: [{display:"grid", clipPath:"circle(100% at center"}, {display:"grid",  clipPath:"circle(0% at center)"}],
            easing:'ease-in-out',
            duration:1000,
            callback:null,
            prefersReducedMotion:"cutOut"
        ...
        "menuInFromBottom": {
            ...
            firstanimation: [{display:"grid", transform: "translateY(100%)"}, {display:"grid",transform: "translateY(%%%)"}],
        ...
        "menuInFromLeft": {
            ...
            firstanimation: [{display:"grid", transform: "translateX(-100%)"}, {display:"grid",transform: "translateX(%%%)"}],
        ...
        "menuOutToLeft": {
            ...
            firstanimation: [{display:"grid", transform: "translateX(%%%)"}, {display:"grid",transform: "translateX(-100%)"}],
            boxShadow: "10px 20px 20px 30px rgba(0,0,0,0.5)",
            easing:'ease-in-out',
            duration:500,
            menuSize:12,
        ...
        "spinIn": {
            ...
            firstanimation: [{display:"grid", transform: "rotate(0deg) scale(0)"}, {display:"grid", transform: "rotate(720deg) scale(1)"}],
            boxShadow: "10px 10px 20px rgba(0,0,0,0.5)",
           easing:'ease-in-out',
           duration:1000,
           callback:null,
        ...
        "spinOut":{
            ...
            firstanimation:[{display:"grid", transform: "rotate(0deg)  scale(1)"}, {display:"grid", transform: "rotate(-720deg) scale(0)"}],
            boxShadow: "10px 10px 20px rgba(0,0,0,0.5)",
            easing:'ease-in-out',
            duration:1000,
            callback:null,
        ...
        "swipeInFromBottom": {
            ...
            firstanimation: [{display:"grid", transform: "translateY(100%)"}, {display:"grid",transform: "translateY(0%)"}],
            boxShadow: "-10px -10px 30px rgba(0,0,0,0.5)",
           easing:'ease-in-out',
           duration:500,
           callback:null,
        ...
        "swipeInFromLeft": {
            ...
            firstanimation: [{display:"grid", transform: "translateX(-100%)"}, {display:"grid",transform: "translateX(0%)"}],
            boxShadow:  "10px 20px 20px 30px rgba(0,0,0,0.5)",
            easing:'ease-in-out',
            duration:500,
            callback:null,
        ...
        "swipeOutToLeft": {
            ...
            firstanimation: [{display:"grid", transform: "translateX(0%)"}, {display:"grid",transform: "translateX(-120%)"}],
            boxShadow: "10px 20px 20px 30px rgba(0,0,0,0.5)",
            easing:'ease-in-out',
            duration:500,
            callback:null,
        ...
        "zoomIn": {
            ...
            firstanimation: [{display:"grid", transform: "scale(0)"}, {display:"grid", transform: "scale(1)"}],
            boxShadow: "10px 10px 20px rgba(0,0,0,0.5)",
            easing:'ease-in-out',
            duration:500,
            callback:null,
        ...
        "zoomOut":{
            ...
            firstanimation: [{display:"grid", transform: "scale(1)"}, {display:"grid", transform: "scale(0)"}],
            boxShadow: "10px 10px 20px rgba(0,0,0,0.5)",
            easing:'ease-in-out',
            duration:500,
            callback:null,
...
/* Performs the callback function for the given transition, if one is specified. */
    performCallback(args){
     ...
     //   self.animationLock = false;
       ...
       if(args.completionHandler !== undefined){
    ...
    irisOutToBlack(args){
        ...
        self.container.append(self.specialtyPanels.blackpanel);
        self.normalizeStack();
        self.specialtyPanels.blackpanel.style.display = "grid";
        self.irisOut(args);
    }
    irisInFromGray(args){
        let self = args.self;
    ...
    irisOutToGray(args){
        ...
        self.container.append(self.specialtyPanels.graypanel);
        self.normalizeStack();
        self.specialtyPanels.graypanel.style.display = "grid";
        self.irisOut(args);
    }
    ...
    irisOutToWhite(args){
        ...
        self.container.append(self.specialtyPanels.whitepanel);
        self.normalizeStack();
        self.specialtyPanels.whitepanel.style.display = "grid";
        self.irisOut(args);
    }
    menuInFromBottom(args){
        ...
        args.finishHandler = function(){
            self.moveToTos(args.selectedPanel,self);
            args.selectedPanel.style.display = "grid";
