; Here be dragons! Theming assumes that you're familiar with CSS, or at
; least want to learn. If you mess up the CSS, you could make your 
; slides unviewable. Always make a backup of your presentation BEFORE
; editing themes. There's a list of CSS rules at the bottom of the
...
.gorilla-presenter-slide {
color: #FFFFFF;
background: linear-gradient(to right, #FF007F, #FFD700, #FF007F);
}

%%% Electric Guitar

.gorilla-presenter-editable h1 {z
color: #000000;
background: #FFD700;
...
.gorilla-presenter-slide {
    color: #1B5E20; 
    background: linear-gradient(to right, #C8E6C9, #388E3C); 
}
...
.gorilla-presenter-slide {
    color: #763C28; 
    background: linear-gradient(to bottom, #FFF0F5, #FAEBD7); 
}
...
.gorilla-presenter-editable h1 {
    color: #F0F8FF; 
    background: linear-gradient(to right, #000080, #5F9EA0); 
    border-bottom: 1px solid #4682B4; 
}
.gorilla-presenter-slide {
    color: #FFFFFF; 
    background: linear-gradient(to bottom, #B0C4DE, #1E90FF); 
}
...
.gorilla-presenter-editable h1 {
    color: #FFD700; 
    background: linear-gradient(to right, #996515, #3E2723); 
...
.gorilla-presenter-slide {
color: #778899;
background: linear-gradient(to bottom, #FFF0F5, #F0FFFF, #F5FFFA);
}
...
.gorilla-presenter-editable h1 {
    color: #00FF00; 
    background: linear-gradient(to right, #000000, #008080); 
    border-bottom: 1px solid #20B2AA; 
}
.gorilla-presenter-slide {
    color: #ADFF2F; 
    background: linear-gradient(to bottom, #006400, #556B2F); 
}
%%% Patchwork Quilt
...
.gorilla-presenter-editable h1 {
color: #5A4E42;
background: linear-gradient(to right, #CDB79E, #8B4513);
...
CSS rule for the level 1 header on the slide, i.e. h1 tags. While you can certainly define rules for h2-h6, those are probably overkill for most slide presentations.
